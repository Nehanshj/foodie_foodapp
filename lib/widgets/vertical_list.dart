...
import 'package:foodie/screens/Restaurant_page.dart';
import 'package:foodie/widgets/rating.dart';

class NearbyRes extends StatelessWidget {

  _buildRes(BuildContext context) {
    List<Widget> resList= [];
              ...
              child: Row(
                children: <Widget>[
                  ClipRRect(
                      ...
                      child: Hero(tag: res.imageUrl,
                          child: Image(image: AssetImage(res.imageUrl),
                            width: 100.0,
                            height: 100.0,
                            fit: BoxFit.cover,))),
                  Container(
